  ...
  return (
    <div className="relative w-screen h-[70dvh] xl:h-screen overflow-hidden border-b-4 border-b-black/70">
      ...
      <button
        name="left swiper"
        ref={prevRef}
        className="absolute top-1/2 left-5 xl:left-12 transform -translate-y-1/2 bg-white rounded-full text-black z-10 p-2 cursor-pointer"
      >
        <ArrowLeft size={16} />
      </button>
      <button
        name="right swiper"
        ref={nextRef}
        className="absolute top-1/2 right-5 xl:right-16 transform -translate-y-1/2 bg-white rounded-full text-black z-10 p-2 cursor-pointer"
      >
        <ArrowRight size={16} />
      </button>
    </div>
